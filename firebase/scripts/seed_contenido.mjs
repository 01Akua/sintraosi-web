...
const paginas = {
  inicio: {
    campos: {
      ...
      regionales_p: "SINTRAOSI tiene presencia activa en cinco ciudades del país.",
  ...
  junta: {
    ...
    listas: {
      junta: [
        { iniciales: "DA", nombre: "Darwin Acevedo Pérez", cargo: "Presidente" },
        { iniciales: "AM", nombre: "Ángela Mahecha", cargo: "Vicepresidenta" },
        { iniciales: "JW", nombre: "Juan Carlos Wtitinghan", cargo: "Secretario General" },
        { iniciales: "CB", nombre: "Carlos Báez", cargo: "Tesorero" },
        { iniciales: "FR", nombre: "Fernando Rey", cargo: "Fiscal" },
        { iniciales: "JR", nombre: "José Ribón", cargo: "Sec. Prensa y Propaganda" },
        { iniciales: "CA", nombre: "Carlos Ahumada", cargo: "Sec. Asuntos Intersindicales" },
        { iniciales: "LA", nombre: "Luis Fernando Acevedo", cargo: "Presidente Seccional Bogotá" },
        { iniciales: "RY", nombre: "Rafael Yépez", cargo: "Comisión de Reclamos" },
      ],
    },
  },
  galeria: {
